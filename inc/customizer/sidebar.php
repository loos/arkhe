...
// サイドバーを表示するかどうか
Customizer::sub_title( $arkhe_section, 'is_show_sidebar',
	array(
...
// トップページに表示する
Customizer::add( $arkhe_section, 'show_sidebar_top',
	array(
...
// 固定ページに表示する
Customizer::add( $arkhe_section, 'show_sidebar_page',
	array(
...
// 投稿ページに表示する
Customizer::add( $arkhe_section, 'show_sidebar_post',
	array(
...
// アーカイブページに表示する
Customizer::add( $arkhe_section, 'show_sidebar_archive',
	array(
